...
// PromiseZ
#define COCOAPODS_POD_AVAILABLE_PromiseZ
#define COCOAPODS_VERSION_MAJOR_PromiseZ 0
#define COCOAPODS_VERSION_MINOR_PromiseZ 2
#define COCOAPODS_VERSION_PATCH_PromiseZ 0
